...
public class DBManagerASF {

	static final Logger logger = Logger.getLogger(DBManagerASF.class);
	...
	public Connection getConnection() throws Exception {
	    ...
	    System.out.println("Before try");   
		    ...
		    prop.load(DBManagerASF.class.getClassLoader().getResourceAsStream(propFileName));
		    
		    url = prop.getProperty("afsweb.url");
		    username = prop.getProperty("afsweb.username");
		    password = prop.getProperty("afsweb.password");
